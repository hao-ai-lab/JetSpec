...
class FlashAttentionForwardSm90(FlashAttentionForwardBase):
    ...
    def __call__(
        ...
        if const_expr(self.has_attention_gate):
            mGate = utils.select(mGate, QO_layout_transpose)
        ...
        if warp_idx_in_wg == 0:
            ...
            while work_tile.is_valid_tile:
                ...
                if const_expr(not self.use_block_sparsity):
                    ...
                    pipeline_k.producer_acquire(kv_producer_state, extra_tx_count=extra_tx_count)
                    if const_expr(self.use_tma_Q):
    ...
    def mma(
        ...
        while work_tile.is_valid_tile:
            ...
            gate_tile = None
            if const_expr(self.has_attention_gate):
                gate_batch = seqlen.offset_batch_Q(mGate, batch_idx, dim=3)[None, None, head_idx]

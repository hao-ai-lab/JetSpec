...
not just the accum_logp-recovering default. Tree speculative decoding is
...
# actually fires (not the accum_logp-identity default). Losslessness must
...
ACTIVE_KWARGS = {
    ...
    "depth_rank_histogram": {"tau": 0.02},  # no profile_table here -> recovers accum_logp
}

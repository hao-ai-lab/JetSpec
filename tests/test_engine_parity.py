...
Recorded reference (Snyhlxde/...-epoch6-no-gamma, crossproduct, width 7,
...
def test_tree_engine_accept_len_parity():
    """crossproduct accept_len on aligned gsm8k stays near the reference (>= floor),
    ...
    for p in prompts:
        out = llm.generate_tree(
            ...
            algo="crossproduct", target_layer_ids=tli, sampling_params=sp, return_stats=True)

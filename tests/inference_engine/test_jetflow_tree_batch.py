...
per-seq KV-routing arithmetic directly. Mirrors `tests/inference_engine/test_jetflow_tree.py`'s and
`tests/inference_engine/test_jetflow_batch.py`'s `_tiny_jetflow` harness. (On b200 in bf16 a batched

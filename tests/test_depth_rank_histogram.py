...
def test_no_profile_recovers_crossproduct():
    """profile_table=None -> b_per_depth = K everywhere -> byte-identical crossproduct."""
    dl = _logits()
    xp = get_algorithm("crossproduct").build(7, dl, BLOCK, WIDTH, BUDGET, DEV)

...
the JetSpec engine (jetspec/core/llm.py) owns the decode + tree-verify loop and stays
...
# ---- vendored from reference utils.py (kept local; JetSpec owns no tree deps) ----
...
# DROPPED: the JetSpec engine owns the decode + tree-verify loop and stays on SDPA.
# ============================================================================

...
imported lazily inside the real implementation, so ``register_jetspec_paged_tree``
...
@torch.library.custom_op("jetspec::paged_tree_attn", mutates_args=())
def paged_tree_attn(
    ...
    from jetspec.inference_engine.paged_tree_attn import paged_tree_attn as _paged_tree_attn_impl

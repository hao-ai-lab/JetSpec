"""Continuous-batching scheduler (JetSpec N2a).

Controls admission, batching, and eviction for a batch of sequences sharing one
`PagedKVCache` pool. The engine (`JetSpecEngine.generate_batch`) owns the forward;
...
from jetspec.inference_engine.paged_kv_cache import EvictionFailed, PagedKVCache
